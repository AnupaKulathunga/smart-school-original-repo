...
(167, 28, 'online_course', NULL, 'online_course', 'admin/onlinecourse/course', 1, '(''online_course'', ''can_view'')', NULL, 'course', 'index', NULL, 1, '2022-05-18 07:50:11'),
(168, 28, 'offline_payment', NULL, 'offline_payment', 'admin/onlinecourse/offlinepayment/payment', 2, '(''online_course_offline_payment'', ''can_view'')', NULL, 'offlinepayment', 'payment', NULL, 1, '2022-12-04 10:26:40'),
(169, 28, 'course_category', NULL, 'course_category', 'admin/onlinecourse/coursecategory/categoryadd', 3, '(''course_category'', ''can_view'') || (''course_category'', ''can_add'') || (''course_category'', ''can_edit'') || (''course_category'', ''can_delete'')', NULL, 'coursecategory', 'categoryadd,categoryedit', NULL, 1, '2023-01-02 09:23:54'),
(180, 28, 'online_course_report', NULL, 'online_course_report', 'admin/onlinecourse/coursereport/report', 4, '(''student_course_purchase_report'', ''can_view'') || (''course_sell_count_report'', ''can_view'') || (''course_trending_report'', ''can_view'') || (''course_complete_report'', ''can_view'') || (''course_rating_report'', ''can_view'') || (''guest_report'', ''can_view'')', NULL, 'coursereport', 'report,coursepurchase,coursesellreport,trendingreport,completereport,courseratingreport,guestlist,quizperformance', NULL, 1, '2022-12-09 05:00:31'),
(197, 28, 'setting', NULL, 'setting', 'admin/onlinecourse/course/setting', 5, '(''online_course_setting'', ''can_view'')', NULL, 'course', 'setting', '', 1, '2022-07-22 01:13:30'),
(222, 28, 'online_course_question_bank', NULL, 'online_course_question_bank', 'admin/onlinecourse/courseexamquestion/index', 3, '(''online_course_question_bank'', ''can_view'') || (''online_course_question_bank'', ''can_add'') || (''online_course_question_bank'', ''can_edit'') || (''online_course_question_bank'', ''can_delete'')', NULL, 'courseexamquestion', 'index', NULL, 1, '2024-12-24 07:02:50')
