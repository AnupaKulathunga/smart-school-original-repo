/**
 * Exam Schedule — Student portal test
 */
...
test.describe('Exam Schedule — Student Portal', () => {

  test('Exam Schedule page loads without errors', async ({ page }) => {
    await studentLogin(page);
    await ensureDashboard(page);

    const response = await page.goto(`${BASE_URL}/user/examschedule`, { waitUntil: 'domcontentloaded' });
