/**
 * Exam Result — Student portal test
 */
...
test.describe('Exam Result — Student Portal', () => {

  test('Exam Result page loads without errors', async ({ page }) => {
    await studentLogin(page);
    await ensureDashboard(page);

    const response = await page.goto(`${BASE_URL}/user/exam/examresult`, { waitUntil: 'domcontentloaded' });
