-- ============================================================================
-- TVET Unified Database Architecture - Migration 011: Core Structure (CLEAN)
-- Drops any existing programme/qualification/level/class tables first
-- Creates fresh unified structure - NO PREFIXES
-- ============================================================================

SET FOREIGN_KEY_CHECKS = 0;

-- Drop any existing new tables (clean slate)
...
-- Also drop old tvet_* tables that may have conflicting constraints
...
DROP TABLE IF EXISTS `tvet_class`;
DROP TABLE IF EXISTS `tvet_subject_level`;
...
CREATE TABLE `qualification` (
  ...
  CONSTRAINT `fk_unified_unified_qualification_programme` FOREIGN KEY (`programme_id`)
...
-- ============================================================================
-- 4. SUBJECT_LEVEL TABLE
-- Which subjects are offered at which levels
-- Uses existing subjects table
-- ============================================================================
...
CREATE TABLE `subject_level` (
  ...
  CONSTRAINT `fk_unified_unified_sl_subject` FOREIGN KEY (`subject_id`)
    REFERENCES `subjects`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_unified_sl_level` FOREIGN KEY (`level_id`)
    REFERENCES `level`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- ============================================================================
-- 5. CLASS TABLE - THE CENTRAL UNIT
...
CREATE TABLE `class` (
  ...
  CONSTRAINT `fk_unified_class_subject_level` FOREIGN KEY (`subject_level_id`)
    REFERENCES `subject_level`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_class_session` FOREIGN KEY (`session_id`)
    REFERENCES `sessions`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_class_lecturer` FOREIGN KEY (`primary_lecturer_id`)
    REFERENCES `staff`(`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- ============================================================================
-- 6. STUDENT_PROGRAMME TABLE
...
CREATE TABLE `student_programme` (
  ...
  KEY `idx_session` (`session_id`),
  KEY `idx_status` (`status`),
  CONSTRAINT `fk_unified_sp_student` FOREIGN KEY (`student_id`)
    REFERENCES `students`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_sp_programme` FOREIGN KEY (`programme_id`)
    REFERENCES `programme`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_sp_qualification` FOREIGN KEY (`qualification_id`)
    REFERENCES `qualification`(`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_sp_level` FOREIGN KEY (`current_level_id`)
    REFERENCES `level`(`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_sp_session` FOREIGN KEY (`session_id`)
    REFERENCES `sessions`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `enrolment` (
  ...
  CONSTRAINT `fk_unified_enrol_student` FOREIGN KEY (`student_id`)
    REFERENCES `students`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_enrol_class` FOREIGN KEY (`class_id`)
    REFERENCES `class`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_enrol_session` FOREIGN KEY (`session_id`)
    REFERENCES `sessions`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_enrol_hostel` FOREIGN KEY (`hostel_room_id`)
    REFERENCES `hostel_rooms`(`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_enrol_route` FOREIGN KEY (`vehroute_id`)
    REFERENCES `transport_route`(`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- ============================================================================
-- 8. CLASS_LECTURER TABLE
...
CREATE TABLE `class_lecturer` (
  ...
  KEY `idx_role` (`role`),
  CONSTRAINT `fk_unified_cl_class` FOREIGN KEY (`class_id`)
    REFERENCES `class`(`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_unified_cl_staff` FOREIGN KEY (`staff_id`)
