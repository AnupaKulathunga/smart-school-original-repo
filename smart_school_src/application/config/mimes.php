...
return array(
    ...
    'scorm' => array('application/x-zip', 'application/zip', 'application/x-zip-compressed', 'application/octet-stream'),
    '7z' => array('application/x-7z-compressed', 'application/x-compressed'),
