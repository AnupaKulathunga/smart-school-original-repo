                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        ?>
                                        <th class="text-right"><?php echo $this->lang->line('total_marks') ?></th>
                                        <th class="text-right"><?php echo $this->lang->line('obtain_marks') ?></th>
        ...
        foreach ($student_data as $student_key => $student_value) {
            ?>
                                            <tr>
                                                ...
                                                ?>
                                                <td class="text-right"><?php echo $student_value['max_question_marks']; ?></td>
                                                <td class="text-right"><?php echo $student_value['get_marks']; ?></td>
                                                <td class="text-right"><?php echo $student_value['percentage']; ?></td>
                                            </tr>
                                            <?php
$count++;
        }
