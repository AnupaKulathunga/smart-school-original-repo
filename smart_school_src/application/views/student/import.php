            ...
            <div class="col-md-12">
                <div class="box box-info" style="padding:5px;">
                    ...
                    <div class="box-body">
                        ...
                        <!-- Admission Number Settings Info -->
                        <?php
                        $sch_setting = $this->setting_model->getSetting();
                        if ($sch_setting->adm_auto_insert == 1) {
                        ?>
                            <div class="alert alert-info">
                                <h4><i class="fa fa-info-circle"></i> Admission Number Auto-Generation Enabled</h4>
                                <p>
                                    <strong>Note:</strong> Admission numbers will be automatically generated during import.
                                    CSV admission_no values will be ignored.
                                </p>
                                <ul>
                                    <li><strong>Prefix:</strong> <?php echo $sch_setting->adm_prefix; ?></li>
                                    <li><strong>Digits:</strong> <?php echo $sch_setting->adm_no_digit; ?></li>
                                    <?php if ($sch_setting->adm_update_status == 1) { ?>
                                        <li><strong>Mode:</strong> Increment from last student</li>
                                    <?php } else { ?>
                                        <li><strong>Mode:</strong> Start from <?php echo $sch_setting->adm_start_from; ?></li>
                                    <?php } ?>
                                </ul>
                                <p class="text-muted">
                                    <small>To change these settings, go to: Admin → Settings → ID Auto Generation</small>
                                </p>
                            </div>
                        <?php } else { ?>
                            <div class="alert alert-warning">
                                <h4><i class="fa fa-exclamation-triangle"></i> Admission Number Auto-Generation Disabled</h4>
                                <p>
                                    <strong>Important:</strong> You must provide unique admission numbers in your CSV file.
                                    The <code>admission_no</code> column is required and must be unique for each new student.
                                </p>
                                <p class="text-muted">
                                    <small>To enable auto-generation, go to: Admin → Settings → ID Auto Generation</small>
                                </p>
                            </div>
                        <?php } ?>
                        ...
                        <div class="instructions">
                            ...
                            <ol>
                                ...
                                <li><strong>Required Fields:</strong>
                                    <ul>
                                        <?php if ($sch_setting->adm_auto_insert == 1) { ?>
                                            <li>admission_no - <span class="text-muted">(Auto-generated, CSV value ignored)</span></li>
                                        <?php } else { ?>
                                            <li><span class="text-red">*</span> admission_no - Student admission/registration number (must be unique)</li>
                                        <?php } ?>
