            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Cohort</h3>
                    </div><!-- /.box-header -->
                                        ...
                                        <select id="programme_id" name="programme_id" class="form-control">
                                            ...
                                            <?php if (!empty($programmes)) {
                                                foreach ($programmes as $programme) { ?>
                                                    <option value="<?php echo $programme['id']; ?>" <?php echo (set_value('programme_id') == $programme['id']) ? 'selected' : ''; ?>><?php echo $programme['name']; ?></option>
                                                <?php }
                                            } ?>
                                        </select>
                            ...
                            <div class="row">
                                        ...
                                        <select id="level_id" name="level_id" class="form-control">
                                            ...
                                            <?php if (!empty($levels)) {
                                                foreach ($levels as $level) { ?>
                                                    <option value="<?php echo $level['id']; ?>" <?php echo (set_value('level_id') == $level['id']) ? 'selected' : ''; ?>><?php echo $level['name']; ?> (<?php echo $level['qualification_name']; ?>)</option>
                                                <?php }
                                            } ?>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="code" name="code" placeholder="e.g., NCV-L2-2024-A" type="text" class="form-control" value="<?php echo set_value('code'); ?>" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="intake_year" name="intake_year" type="number" class="form-control" min="2000" max="2100" value="<?php echo set_value('intake_year', date('Y')); ?>" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="delivery_mode" name="delivery_mode" class="form-control">
                                            ...
                                            <option value="Full-time" <?php echo (set_value('delivery_mode') == 'Full-time') ? 'selected' : ''; ?>>Full-time</option>
                                            <option value="Part-time" <?php echo (set_value('delivery_mode') == 'Part-time') ? 'selected' : ''; ?>>Part-time</option>
                                            <option value="Evening" <?php echo (set_value('delivery_mode') == 'Evening') ? 'selected' : ''; ?>>Evening</option>
                                            <option value="Weekend" <?php echo (set_value('delivery_mode') == 'Weekend') ? 'selected' : ''; ?>>Weekend</option>
                                            <option value="Distance" <?php echo (set_value('delivery_mode') == 'Distance') ? 'selected' : ''; ?>>Distance</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="max_students" name="max_students" type="number" class="form-control" min="1" value="<?php echo set_value('max_students', '40'); ?>" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="start_date" name="start_date" type="date" class="form-control" value="<?php echo set_value('start_date'); ?>" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="end_date" name="end_date" type="date" class="form-control" value="<?php echo set_value('end_date'); ?>" />
