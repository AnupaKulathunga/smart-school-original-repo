...
<form id="edit_course_form_ID" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-8">
               ...
               <!-- class_sections_id no longer needed in TVET - class_id[] multi-select is used instead -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select autofocus="" id="edit_class_id" name="class_id[]" class="form-control class-list" multiple="multiple">
                            <?php
if (!empty($classlist)) {
    $selected_ids = isset($selected_class_ids) ? $selected_class_ids : array();
    foreach ($classlist as $classlist_value) {
        $selected = in_array($classlist_value['id'], $selected_ids) ? 'selected' : '';
        ?>
              <option value="<?php echo $classlist_value['id']; ?>" <?php echo $selected; ?>><?php echo $classlist_value['class']; ?></option>
                            <?php
    }
}
?>
...
(function ($) {
  "use strict";
    // TVET: Initialize multi-select class dropdown with select2
    $('.class-list').select2();
})(jQuery);
