...
<body>
  <div class="container">
    ...
    ?>
        ...
        <h5 class="bolder"><?php echo $this->lang->line(strtolower($tm_key)); ?></h5>
        <?php
        ...
        ?>
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                <td width='35%' class="font-medium"><?php echo $this->lang->line('subject'); ?></td>
                <td width='25%' class="font-medium"><?php echo $this->lang->line('time'); ?></td>
                <td width='20%' class="font-medium"><?php echo $this->lang->line('teacher'); ?></td>
                <td width='20%' class="font-medium"><?php echo $this->lang->line('room_no'); ?></td>
          ...
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                <td width='35%' class="font-medium"><?php echo $this->lang->line('subject'); ?></td>
                <td width='25%' class="font-medium"><?php echo $this->lang->line('time'); ?></td>
                <td width='25%' class="font-medium"><?php echo $this->lang->line('teacher'); ?></td>
                <td width='20%' class="font-medium"><?php echo $this->lang->line('room_no'); ?></td>
              </tr>
            </thead>
            <tbody>
