                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_disability_type'); ?></h3>
                        </div>
                        <form id="form1" action="<?php echo site_url('disabilitytype/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description" class="form-control" rows="2"><?php echo set_value('description'); ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="default_extra_time_percent"><?php echo $this->lang->line('default_extra_time'); ?> (%)</label><small class="req"> *</small>
                                    <input id="default_extra_time_percent" name="default_extra_time_percent" type="number" class="form-control" value="<?php echo set_value('default_extra_time_percent', '25'); ?>" min="0" max="200" />
                                ...
                                <tbody>
                                    ...
                                    foreach ($typelist as $type) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><?php echo $type['description'] ?></td>
                                            <td class="mailbox-name"><?php echo $type['default_extra_time_percent'] ?>%</td>
                                            <td class="mailbox-date pull-right">
                                                <?php
                                                if ($this->rbac->hasPrivilege('disability_types', 'can_edit')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>disabilitytype/edit/<?php echo $type['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                ...
                                                if ($this->rbac->hasPrivilege('disability_types', 'can_delete')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>disabilitytype/delete/<?php echo $type['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
